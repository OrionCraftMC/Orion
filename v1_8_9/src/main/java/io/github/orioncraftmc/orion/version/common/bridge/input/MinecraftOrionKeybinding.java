...
package io.github.orioncraftmc.orion.version.common.bridge.input;
...
public class MinecraftOrionKeybinding extends KeyBinding {
	...
	public MinecraftOrionKeybinding(OrionKeybinding orionKeybinding) {
		super(orionKeybinding.getId(), orionKeybinding.getKeyCode().getKeyCode(), "key.categories.orioncraft");
