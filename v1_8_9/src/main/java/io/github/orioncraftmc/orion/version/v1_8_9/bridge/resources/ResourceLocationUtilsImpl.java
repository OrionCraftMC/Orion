...
package io.github.orioncraftmc.orion.version.v1_8_9.bridge.resources;
...
public class ResourceLocationUtilsImpl implements ResourceLocationUtils {
	...
	public ResourceLocationBridge createNewMinecraftResourceLocation(@NotNull String s) {
		return (ResourceLocationBridge) new ResourceLocation(OrionCraftConstants.MINECRAFT_RESOURCE_LOCATION_NS, s);
	}

	@NotNull
	@Override
	public ResourceLocationBridge createNewOrionResourceLocation(@NotNull String s) {
		return (ResourceLocationBridge) new ResourceLocation(OrionCraftConstants.ORION_RESOURCE_LOCATION_NS, s);
	}
}
