...
public abstract class OrionGuiListExtended
	...
	public void drawSlot(int integer1, int integer2, int integer3, int integer4, int integer5, int integer6) {
		this.getListEntry(integer1)
				.drawEntry(integer1, integer2, integer3, this.getListWidth(), integer4, integer5, integer6,
						this.getSlotIndexFromScreenCoords(integer5, integer6) == integer1);
	}
	...
	public boolean mouseClicked(int integer1, int integer2, int integer3) {
		int integer5;
		if (this.isMouseYWithinSlotBounds(integer2) && (integer5 = this.getSlotIndexFromScreenCoords(integer1,
				integer2)) >= 0) {
