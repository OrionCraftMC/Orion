...
public abstract class OrionGuiSlot {
    ...
    public void drawScreen(int integer1, int integer2, float float3) {
        ...
        if (integer13 > 0) {
            ...
            int integer15 = (int)this.amountScrolled * (this.bottom - this.top - (integer14 = MathHelper.clamp_int(integer14, 32, this.bottom - this.top - 8))) / integer13 + this.top;
            ...
            if (this.initialClickY == -1) {
                ...
                if (this.mouseY >= this.top && this.mouseY <= this.bottom) {
                    ...
                    if (integer6 < this.getSize() && this.mouseX >= integer3 && this.mouseX <= integer4 && integer6 >= 0 && integer5 >= 0) {
                        ...
                        this.func_148132_a(this.mouseX - integer3, this.mouseY - this.top + (int)this.amountScrolled - 4);
                        boolean2 = false;
                    }
